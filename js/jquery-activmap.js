...
(function($){
    ...
    $.activmap = {
        ...
        defaults: {
            ...
            cluster: false,         //enables / disables clustering for large amounts of markers
            mapType: 'roadmap',    //map type : "roadmap", "satellite", "perspective"
            posPanel: 'right',      //position of the removable panel : "left" or "right"
        ...
        activmap : function(settings){
            ...
            _init = function(){
                ...
                $.each(s.places, function(i, place){
                    ...
                    mycontent += '<div class="activmap-details"><div class="activmap-title">'+place.title+'</div>';
                    if(place.address != undefined && place.address != '') mycontent += '<div class="activmap-address"><i class="fa fa-map-marker"></i> '+place.address+'</div>';
                    if(place.phone != undefined && place.phone != '') mycontent += '<a href="tel:'+place.phone+'" class="activmap-phone"><i class="fa fa-phone"></i> '+place.phone+'</a>';
                    if(place.email != undefined && place.email != '') mycontent += '<a href="mailto:'+place.email+'" class="activmap-email"><i class="fa fa-envelope"></i> '+place.email+'</a>';
                    if(place.description != undefined && place.description != '') mycontent += '<div class="activmap-description">'+place.description+'</div>';
                    ...
                    google.maps.event.addListener(marker, 'click', function(){
                        ...
                        activmap_places.scrollTop(activmap_places.scrollTop()+$('#activmap-place_'+i).position().top-$('.activmap-place').height());
                    });
                    ...
                    place.html = '<div class="activmap-place" id="activmap-place_'+i+'"><div class="name">'+place.title+'</div></div>';
            ...
            _map_resize = function() {
                ...
                if(num_places > 0){
                    ...
                    var padbnds = _paddedBounds(10, 100, 50, 50);
                    map.fitBounds(padbnds);
